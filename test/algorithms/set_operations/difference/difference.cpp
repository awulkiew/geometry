...
#if defined(BOOST_GEOMETRY_NO_ROBUSTNESS)
    test_one<polygon, polygon, polygon>(
            "case99m", case_99m[0], case_99m[1],
            1, 9, 71938982209960000,
            1, 5, 2.40230376e+20);
    test_one<polygon, polygon, polygon>(
            "case100m", case_100m[0], case_100m[1],
            1, 9, 1108087364.695,
            1, 5, 1.49257218e+22,
            1, 10, 1108087364.695);
    test_one<polygon, polygon, polygon>(
            "case101m", case_101m[0], case_101m[1],
            2, 10, 332066650.1372,
            2, 10, 4.41568936e+20,
            2, 15, 410392630.5984);
    test_one<polygon, polygon, polygon>(
            "case102m", case_102m[0], case_102m[1],
...
<<<<<<< HEAD
    int const correction_for_invalidity = 0; // should be 0
