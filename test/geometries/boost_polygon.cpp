...
void test_coordinate_type()
{
    ...
    bg::concept::check_concept<boost::polygon::point_data<T> >();
    ...
    bg::concept::check_concept<boost::polygon::rectangle_data<T> >();
    ...
    bg::concept::check_concept<boost::polygon::polygon_data<T> >();
